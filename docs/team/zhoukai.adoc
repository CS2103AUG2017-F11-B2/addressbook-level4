...
=== Enhancement Added: 
V1.0: add colors to tag
V1.1: make email and address optional when add contact 
...
-For V1.1: the addressbook accepts empty string for now, we could add an internal(private) tag to group the 
incomplete contacts together
